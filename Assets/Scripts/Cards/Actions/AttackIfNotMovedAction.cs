...
{
    public class AttackIfNotMovedAction: AbstractAction
    {
        ...
        public AttackIfNotMovedAction(int baseCost, string color, AbstractEntity entity, int amount) : base(baseCost, color, entity)
        {
            _amount = amount;
        }
