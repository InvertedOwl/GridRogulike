...
{
    public class FrostAttackAction: AttackAction
    {
        public int frostAmount;

        public FrostAttackAction(int baseCost, string color, AbstractEntity entity, string direction, int distance, int _amount, int frostAmount) : base(baseCost, color, entity, direction, distance, _amount)
        {
        ...
        {
            return new List<AbstractCardEvent> { new AttackCardEvent(_distance, _direction, _amount, new FrostStatus(frostAmount)) };
        }
        ...
        {
            return  "<frost>" + frostAmount + "     " + "<arrow>" + Distance;
        }
